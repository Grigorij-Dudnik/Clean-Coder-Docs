...
7. (Optional) It's recommended to run
```
python tools/rag/write_descriptions.py
```
to set create descriptions for a rag tool. Read more on the [rag tool page](/advanced_features_installation/similarity_search_for_researcher/).
...
<VideoEmbed videoId="PEPfDQyGE9w" title="Microphone feature" />
